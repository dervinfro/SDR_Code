...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._transition_width_line_edit.returnPressed.connect(
            lambda: self.set_transition_width(eng_notation.str_to_num(str(self._transition_width_line_edit.text()))))
        self.top_grid_layout.addWidget(self._transition_width_tool_bar)
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1568, 0.1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 659.2, 0.1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 261.9, 0.1, 0, 0)
    ...
    def set_transition_width(self, transition_width):
        ...
        Qt.QMetaObject.invokeMethod(self._transition_width_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.transition_width)))
