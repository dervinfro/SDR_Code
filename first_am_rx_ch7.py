...
class first_am_rx_ch7(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "second am rx ch8")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("second am rx ch8")
        ...
        self.settings = Qt.QSettings("GNU Radio", "first_am_rx_ch7")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/pi/Downloads/fesdr-examples-vol1-master/ch6/am_broadcast_02_c900k_s400k.iq', True, 0, 0)
...
def main(top_block_cls=first_am_rx_ch7, options=None):
