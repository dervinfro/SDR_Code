...
class gain_CH7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "gain_CH7")
        ...
        # Blocks
        ##################################################
        self._gain_range = Range(0, 100, 1, 1, 100)
...
def main(top_block_cls=gain_CH7, options=None):
