...
class freq_shift_CH8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "freq_shift_CH8")
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_freq_sink_x_0_1_0_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0_1_0, 0))
...
def main(top_block_cls=freq_shift_CH8, options=None):
