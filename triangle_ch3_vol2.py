...
class triangle_ch3_vol2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "triangle_ch3_vol2")
        ...
        # Variables
        ##################################################
        self.sensitivity = sensitivity = 1
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 0.2, 2, -1, 0)
...
def main(top_block_cls=triangle_ch3_vol2, options=None):
