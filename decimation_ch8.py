...
class decimation_ch8(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "decimation ch8")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("decimation ch8")
        ...
        self.settings = Qt.QSettings("GNU Radio", "decimation_ch8")
...
def main(top_block_cls=decimation_ch8, options=None):
